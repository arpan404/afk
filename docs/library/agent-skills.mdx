...
The Skills CLI installs the selected skill into the configured agent environment. See [skills.sh](https://www.skills.sh/) for CLI details and supported agents.
