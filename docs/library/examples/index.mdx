...
| Advanced     | Production Client    | Timeout middleware, Redis connection pooling, graceful shutdown |
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/library/snippets/14_production_client"
    icon="server"
  >
    Production-ready LLM client with timeout middleware, Redis connection pooling,
